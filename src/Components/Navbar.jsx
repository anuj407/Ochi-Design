...
function Navbar() {
 ...
 const handleClick=()=>{
  ...
  return (
    <div className={`${click ?`bg-zinc-950 pb-12`:`backdrop-blur mix-blend-difference`} w-[100vw] fixed z-50 py-6 px-10 flex justify-between items-center font-['Neue_Montreal']`}>
