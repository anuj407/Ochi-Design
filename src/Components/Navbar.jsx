...
function Navbar() {
 ...
 const handleClick=()=>{
  ...
  return (
    <div className={`${click ?`bg-zinc-950 pb-12`:`backdrop-blur mix-blend-difference`} px-6 w-screen fixed z-50 py-6 md:px-10 flex justify-between items-center font-['Neue_Montreal']`}>
