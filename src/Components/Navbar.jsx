...
function Navbar() {
 ...
 const handleClick=()=>{
  ...
  return (
    <div className={`${click ?`bg-zinc-950 pb-12`:`backdrop-blur mix-blend-difference`} w-full fixed z-50 py-6 px-10 flex justify-between items-center font-['Neue_Montreal']`}>
        ...
        <div className={`absolute z-[999] w-full ${click ? `translate-y-0`:`-translate-y-[120%]`} duration-1000 left-0 h-[90vh] bg-zinc-950 top-[15vh] pt-[8vw] pl-[8vw] gap-[3vh] flex-col border-t-[1px] border-zinc-200 lg:pl-0 lg:bg-transparent lg:pt-0 lg:border-none lg:flex-row lg:top-[2rem] lg:w-fit lg:h-fit lg:relative flex lg:gap-10 `}>
        {links.map((item,index)=><a  onMouseEnter={()=>handleHover(index)} onMouseLeave={()=>handleLeave(index)} className={`relative w-fit text-[11vw] leading-[10.2vw] h-[11vw] font-extralight lg:leading-[2.9vh] lg:opacity-80 lg:text-[1.07rem] cursor-pointer lg:h-[3vh] overflow-hidden  ${index == 4 &&`lg:ml-[19vw]`} `} key={index}>
