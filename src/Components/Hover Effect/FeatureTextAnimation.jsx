...
function FeatureTextAnimation({title,animate,index}) {
  return (
            <h1 className={`text-[17vw] h-[16vw] text-[#EC6234] lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-[50%] lg:-translate-y-[50%] lg:text-[#cdea68] font-semibold font-['Founders_Grotesk_X_Condensed'] uppercase lg:text-[8vw] lg:leading-[8.5vw] lg:h-[5.5vw] flex overflow-hidden `}>
